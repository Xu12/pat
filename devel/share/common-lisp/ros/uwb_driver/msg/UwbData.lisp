...
(cl:defmethod cl:initialize-instance :after ((m <UwbData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UwbData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uwb_driver-msg:<UwbData> is deprecated: use uwb_driver-msg:UwbData instead.")))
...
(cl:defmethod source_id-val ((m <UwbData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uwb_driver-msg:source_id-val is deprecated.  Use uwb_driver-msg:source_id instead.")
  (source_id m))

(cl:ensure-generic-function 'source_idx-val :lambda-list '(m))
(cl:defmethod source_idx-val ((m <UwbData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uwb_driver-msg:source_idx-val is deprecated.  Use uwb_driver-msg:source_idx instead.")
  (source_idx m))
...
(cl:defmethod data_size-val ((m <UwbData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uwb_driver-msg:data_size-val is deprecated.  Use uwb_driver-msg:data_size instead.")
  (data_size m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <UwbData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uwb_driver-msg:data-val is deprecated.  Use uwb_driver-msg:data instead.")
  (data m))
