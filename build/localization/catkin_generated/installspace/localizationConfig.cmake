...
if("FALSE" STREQUAL "TRUE")
  set(localization_SOURCE_PREFIX /home/xufang/pathcheck/src/localization)
  set(localization_DEVEL_PREFIX /home/xufang/pathcheck/devel)
  ...
  set(localization_INSTALL_PREFIX /home/xufang/pathcheck/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'eee <wang.chen@zoho.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xufang/pathcheck/install/${idir}'.  Ask the maintainer 'eee <wang.chen@zoho.com>' to fix it.")
    endif()
    _list_append_unique(localization_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "localization")
...
set(depends "eigen_conversions;geometry_msgs;message_generation;message_runtime;message_filters;roscpp;rospy;std_msgs")
